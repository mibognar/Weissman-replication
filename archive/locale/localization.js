 ...
 */
const LOC_STRINGS = {
    'g_c_firefox_notification_title':{
        'EN': "Firefox not allowed",
        'CZ': "Firefox není povolen",
        'HUN': "Firefox nem engedélyezett"
    },
    'g_c_firefox_notification_text': {
        'EN': "This experiment can't be run on firefox browsers. Please choose an other browser to run this experiment! (Chrome, Edge, Opera, Safari)",
        'CZ': "Tento experiment nelze spustit v prohlížeči Firefox. Chcete-li spustit tento experiment, vyberte jiný prohlížeč! (Chrome, Edge, Opera, Safari)",
        'HUN': "Ez a kísérlet nem futtatható firefox böngészővel. Kérlek válassz egy másik böngészőt a kísérlet futtatásához! (Chrome, Edge, Opera, Safari)"
    },
    'g_c_title': {
        'EN': "Inform form:",
        'CZ': "Prohlášení:",
    ...
    'g_c_summary': {
        ...
        'HUN': "A kutatás célja egy korábbi kísérlet megismétlése. A kísérlet azt kutatja, hogyan dolgozod fel az információkat és hozol döntéseket."
    },
    'g_c_data': {
        ...
        'HUN': "Szigorúan bizalmasan kezelünk minden olyan személyes információt, amit a kutatás keretén belül gyűjtünk össze. A kutatás során gyűjtött adatokat kóddal ellátva biztonságos számítógépeken tároljuk. Az ELTE PPK Affektív Pszichológia Tanszék Döntéspszichológiai Kutatócsoportja mint adatkezelő, fenti személyes adataidat bizalmasan kezeli, más adatkezelőnek, adatfeldolgozónak nem adja át. E tényállás részleteit a „Hozzájárulás adatkezeléshez” c. dokumentum tartalmazza: http://decisionlab.elte.hu/hozzajarulas-adatkezeleshez/ Az adatkezelésről szóló szabályozásról részletesebben pedig itt tájékozódhatsz: https://ppk.elte.hu/file/Hozzajarulas_adatkezeleshez_melleklet_2018.pdf A kutatás során gyűjtött személyes adataidat arra használjuk fel, hogy a két kísérletben adott válaszait össze tudjuk kötni. Az azonosítására alkalmas adatokat (NEPTUN kód) ezután törölni fogjuk. Az anononimizált adatokat ezután más kutatókkal megosztjuk."
    ...
    'g_c_participation': {
        ...
        'HUN': "A kutatásban való részvétel teljesen önkéntes. A vizsgálatot bármikor indoklás nélkül megszakíthatod, vagy a kérdések megválaszolását megtagadhatod a böngésző ablak bezárásával. FIGYELEM: A kísérlet a nyugalom megzavarására alkalmas szavakat is tartalmaz. Ha bármilyen kérdésed, aggályod vagy panaszod van a kísérlettel kapcsolatban, kérem keresd Bognár Miklóst bognar.miklos@ppk.elte.hu"
    },
    ...
    'g_c_aff_words_participation': {
        'EN': "<strong>participation</strong>: text",
        'CZ': "Účast ve studii je zcela dobrovolná and můžete se z ní kdykoli odhlásit uzavřením okna internetového prohlížeče. Po sesbírání všech dat vylosujeme 25 lidí a každý vylosovaný obdrží 200,-Kč. Pokud nedokončíte úlohu, nebo pokud ji dokončíte pod spodní hranicí výkonu, nemůžeme Vás zařadit do slosování o odměnu.",
        'HUN': "A kutatásban való részvétel teljesen önkéntes. A vizsgálatot bármikor indoklás nélkül megszakíthatod, vagy a kérdések megválaszolását megtagadhatod a böngésző ablak bezárásával. FIGYELEM: A kísérlet a nyugalom megzavarására alkalmas képeket is tartalmaz."
    },
    'g_c_title2': {
        'EN': "Consent form",
    ...
    'g_g_end_contact': {
        ...
        'HUN': "Ha bármi kérdésed vagy megjegyzésed van, kérlek vedd fel a kapcsolatot a kutatás vezetőjével ezen az email címen: <a href='mailto:miklos.bognar92@gmail.com?subject=Weissman experiment'>miklos.bognar92@gmail.com</a>!"
    },
    'g_g_data_save_ok': {
        'EN': "The data have been saved successfully.",
        'CZ': "Data byla úspěšně uložena",
        'HUN': "Az eredményed elmentésre került. Kövesd ezt a linket, hogy beírhassuk a pontot:<a href='https://forms.gle/2uiWzMm5P7wgxigx8'>https://forms.gle/2uiWzMm5P7wgxigx8</a> "
    },
    'g_g_data_save_error': {
    ...
    'g_h_affective_primeprobe': {
        'EN': "Second word",
        'CZ': "Druhé slovo",
        'HUN': "Második szó"
    },
    'g_h_affective_words_primeprobe': {
        'EN': "Second word",
        'CZ': "Druhé slovo",
        'HUN': "Második szó"
    },
...
const LOC_IMG = {
    ...
    'i_keyboard': {
        'EN': "assets/simon/Keyboard2.jpg",
        'CZ': "assets/simon/Keyboard2.jpg",
        'HUN': "assets/simon/Keyboard2.jpg"
    },
    'p_keyboard': {
        'EN': "assets/primeprobe/Keyboard.jpg",
        'CZ': "assets/simon/Keyboard_p_CZ.png",
        'HUN': "assets/primeprobe/Keyboard_p_HUN.png"
    },
    'p_ex1': {
    ...
    's_keyboard': {
        'EN': "assets/stroop/Keyboard.png",
        'CZ': "assets/stroop/Keyboard_s_CZ.png",
        'HUN': "assets/stroop/Keyboard_s_HUN.png"
    },
    's_ex1': {
